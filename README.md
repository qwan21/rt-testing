...
Ниже приведены маршруты для работы с сервером. 
  

* GET     http://endstream-name/v1/product/get              получить продукт 
* POST    http://endstream-name/v1/product/find             возвращает предложение по условию
*         http://endstream-name/v1/api/shutdown             останавока сервера (graceful shutdown)
